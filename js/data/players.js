...
//
// position: 'vanguard' | 'ranger' | 'arcanist' | 'hunter' | 'warden'
// playStyle: 'carry' | 'utility' | 'aggressive' | 'passive' | 'playmaker' | 'shotcaller' | 'flex'
//
// Stat guide by position:
//   vanguard  — high mechanics, teamfightPositioning; lower csAccuracy
//   ranger    — high mapMovement, objectiveExecution; moderate all-round
//   arcanist  — high mechanics, csAccuracy, decisionMaking
//   hunter    — high csAccuracy, mechanics, teamfightPositioning
//   warden    — high communication, gameSense, teamfightPositioning; low csAccuracy
...
const PLAYER_DB = [
  ...
  { id:'p001', name:'Ironclad',  teamId:'vs', position:'vanguard',  age:25, nationality:'KOR',
    playStyle:'utility',
    champions:['Deeproot','Ironbark','Grovekeeper','Briarvex'],
  ...
  { id:'p002', name:'Phantom',   teamId:'vs', position:'ranger',    age:23, nationality:'KOR',
    playStyle:'aggressive',
    champions:['Hexwing','Fangwhisper','Wanderclaw','Shade'],
  ...
  { id:'p003', name:'Solaris',   teamId:'vs', position:'arcanist',  age:21, nationality:'KOR',
    playStyle:'carry',
    champions:['Voidthorn','Shade','Stormcaller','Mirethyst','Crystalmind'],
  ...
  { id:'p004', name:'Wraith',    teamId:'vs', position:'hunter',    age:22, nationality:'KOR',
    playStyle:'carry',
  ...
  { id:'p005', name:'Oracle',    teamId:'vs', position:'warden',    age:28, nationality:'KOR',
    playStyle:'shotcaller',
    champions:['Bloomweave','Thornshield','Moonsong','Ashroot'],
  ...
  { id:'p011', name:'Boulder',   teamId:'ic', position:'vanguard',  age:26, nationality:'USA',
    playStyle:'utility',
    champions:['Grovekeeper','Deeproot','Thornback','Bogmaw'],
  ...
  { id:'p012', name:'Flicker',   teamId:'ic', position:'ranger',    age:24, nationality:'BRA',
    playStyle:'aggressive',
    champions:['Hexwing','Wanderclaw','Fangwhisper','Driftblade'],
  ...
  { id:'p013', name:'Noctis',    teamId:'ic', position:'arcanist',  age:24, nationality:'FRA',
    playStyle:'carry',
    champions:['Shade','Voidthorn','Grovefire','Emberveil','Mirethyst'],
  ...
  { id:'p014', name:'Vortex',    teamId:'ic', position:'hunter',    age:22, nationality:'KOR',
    playStyle:'carry',
    champions:['Starshot','Ironpetal','Swiftarrow','Embervane'],
    contract:{ salary:200000, yearsLeft:2, expiryYear:2028 },
  ...
  { id:'p015', name:'Shelter',   teamId:'ic', position:'warden',    age:27, nationality:'CAN',
    playStyle:'utility',
    champions:['Thornshield','Bloomweave','Ashroot','Moonsong'],
  ...
  { id:'p021', name:'Sledge',    teamId:'pa', position:'vanguard',  age:25, nationality:'GER',
    playStyle:'aggressive',
    champions:['Thornback','Briarvex','Grovekeeper','Bogmaw'],
  ...
  { id:'p022', name:'Drift',     teamId:'pa', position:'ranger',    age:23, nationality:'USA',
    playStyle:'aggressive',
    champions:['Fangwhisper','Hexwing','Wanderclaw','Driftblade'],
  ...
  { id:'p023', name:'Prism',     teamId:'pa', position:'arcanist',  age:22, nationality:'POL',
    playStyle:'carry',
    champions:['Grovefire','Stormcaller','Mirethyst','Voidthorn'],
  ...
  { id:'p024', name:'Ricochet',  teamId:'pa', position:'hunter',    age:24, nationality:'USA',
    playStyle:'carry',
    champions:['Swiftarrow','Ironpetal','Embervane','Duskwarden'],
  ...
  { id:'p025', name:'Aegis',     teamId:'pa', position:'warden',    age:26, nationality:'KOR',
    playStyle:'playmaker',
    champions:['Thornshield','Bloomweave','Ashroot','Moonsong'],
  ...
  { id:'p031', name:'Bulwark',   teamId:'tw', position:'vanguard',  age:23, nationality:'USA',
    playStyle:'utility',
    champions:['Deeproot','Ironbark','Stonehide','Ashenveil'],
  ...
  { id:'p032', name:'Cipher',    teamId:'tw', position:'ranger',    age:21, nationality:'KOR',
    playStyle:'aggressive',
    champions:['Hexwing','Shade','Fangwhisper','Wanderclaw'],
  ...
  { id:'p033', name:'Ember',     teamId:'tw', position:'arcanist',  age:24, nationality:'ITA',
    playStyle:'carry',
    champions:['Emberveil','Rootweave','Crystalmind','Grovefire'],
  ...
  { id:'p034', name:'Shatter',   teamId:'tw', position:'hunter',    age:23, nationality:'AUS',
    playStyle:'carry',
    champions:['Duskwarden','Starshot','Ironpetal','Swiftarrow'],
  ...
  { id:'p035', name:'Valor',     teamId:'tw', position:'warden',    age:25, nationality:'USA',
    playStyle:'playmaker',
    champions:['Bloomweave','Moonsong','Ashroot','Thornshield'],
  ...
  { id:'p041', name:'Bastion',   teamId:'dp', position:'vanguard',  age:27, nationality:'KOR',
    playStyle:'utility',
    champions:['Bogmaw','Grovekeeper','Ironbark','Ashenveil'],
    contract:{ salary:105000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'p042', name:'Feral',     teamId:'dp', position:'ranger',    age:22, nationality:'ROM',
    playStyle:'aggressive',
    champions:['Fangwhisper','Wanderclaw','Driftblade','Hexwing'],
  ...
  { id:'p043', name:'Hexis',     teamId:'dp', position:'arcanist',  age:21, nationality:'USA',
    playStyle:'carry',
    champions:['Shade','Voidthorn','Mirethyst','Driftblade'],
  ...
  { id:'p044', name:'Cinder',    teamId:'dp', position:'hunter',    age:23, nationality:'JPN',
    playStyle:'carry',
    champions:['Embervane','Swiftarrow','Ironpetal','Duskwarden'],
    contract:{ salary:90000, yearsLeft:2, expiryYear:2028 },
  ...
  { id:'p045', name:'Wick',      teamId:'dp', position:'warden',    age:25, nationality:'USA',
    playStyle:'utility',
    champions:['Thornshield','Bloomweave','Moonsong','Ashroot'],
  ...
  { id:'p051', name:'Rampart',   teamId:'ge', position:'vanguard',  age:26, nationality:'USA',
    playStyle:'utility',
    champions:['Thornback','Deeproot','Bogmaw','Stonehide'],
  ...
  { id:'p052', name:'Skitter',   teamId:'ge', position:'ranger',    age:21, nationality:'CAN',
    playStyle:'aggressive',
    champions:['Hexwing','Fangwhisper','Wanderclaw'],
  ...
  { id:'p053', name:'Pulsar',    teamId:'ge', position:'arcanist',  age:20, nationality:'KOR',
    playStyle:'carry',
    champions:['Grovefire','Stormcaller','Rootweave','Emberveil'],
  ...
  { id:'p054', name:'Ash',       teamId:'ge', position:'hunter',    age:24, nationality:'USA',
    playStyle:'carry',
  ...
  { id:'p055', name:'Tangle',    teamId:'ge', position:'warden',    age:22, nationality:'AUS',
    playStyle:'utility',
    champions:['Bloomweave','Ashroot','Moonsong','Thornshield'],
    contract:{ salary:65000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'p061', name:'Crumble',   teamId:'af', position:'vanguard',  age:28, nationality:'USA',
    playStyle:'utility',
    champions:['Grovekeeper','Ironbark','Stonehide'],
  ...
  { id:'p062', name:'Lurk',      teamId:'af', position:'ranger',    age:21, nationality:'USA',
    playStyle:'aggressive',
    champions:['Wanderclaw','Driftblade','Hexwing'],
  ...
  { id:'p063', name:'Flare',     teamId:'af', position:'arcanist',  age:20, nationality:'KOR',
    playStyle:'carry',
    champions:['Grovefire','Emberveil','Voidthorn'],
    contract:{ salary:50000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'p064', name:'Tumble',    teamId:'af', position:'hunter',    age:22, nationality:'USA',
    playStyle:'carry',
    champions:['Ironpetal','Swiftarrow','Duskwarden'],
    contract:{ salary:50000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'p065', name:'Petal',     teamId:'af', position:'warden',    age:19, nationality:'USA',
    playStyle:'utility',
    champions:['Bloomweave','Moonsong','Ashroot'],
  ...
  { id:'p071', name:'Topple',    teamId:'hc', position:'vanguard',  age:27, nationality:'USA',
    playStyle:'utility',
    champions:['Deeproot','Bogmaw','Thornback'],
    contract:{ salary:50000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'p072', name:'Stumble',   teamId:'hc', position:'ranger',    age:20, nationality:'USA',
    playStyle:'aggressive',
    champions:['Hexwing','Wanderclaw','Fangwhisper'],
    contract:{ salary:40000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'p073', name:'Glimmer',   teamId:'hc', position:'arcanist',  age:19, nationality:'CAN',
    playStyle:'carry',
    champions:['Grovefire','Emberveil','Mirethyst'],
    contract:{ salary:40000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'p074', name:'Splinter',  teamId:'hc', position:'hunter',    age:22, nationality:'USA',
    playStyle:'carry',
    champions:['Swiftarrow','Ironpetal','Embervane'],
  ...
  { id:'p075', name:'Wisp',      teamId:'hc', position:'warden',    age:21, nationality:'USA',
    playStyle:'utility',
    champions:['Bloomweave','Thornshield','Moonsong'],
    contract:{ salary:38000, yearsLeft:1, expiryYear:2027 },
  ...
  { id:'fa001', name:'Rampage',  teamId:null, position:'vanguard',  age:30, nationality:'KOR',
    playStyle:'utility',
    champions:['Grovekeeper','Thornback','Ironbark','Deeproot'],
  ...
  { id:'fa002', name:'Mirage',   teamId:null, position:'arcanist',  age:26, nationality:'ESP',
    playStyle:'carry',
    champions:['Shade','Stormcaller','Crystalmind','Rootweave'],
    contract:{ salary:0, yearsLeft:0, expiryYear:2026 },
  ...
  { id:'fa003', name:'Lancer',   teamId:null, position:'hunter',    age:27, nationality:'USA',
    playStyle:'carry',
    champions:['Duskwarden','Starshot','Swiftarrow','Embervane'],
    contract:{ salary:0, yearsLeft:0, expiryYear:2026 },
  ...
  { id:'fa004', name:'Weaver',   teamId:null, position:'warden',    age:29, nationality:'KOR',
    playStyle:'shotcaller',
    champions:['Thornshield','Bloomweave','Moonsong','Ashroot'],
    contract:{ salary:0, yearsLeft:0, expiryYear:2026 },
  ...
  { id:'fa005', name:'Striker',  teamId:null, position:'ranger',    age:25, nationality:'SWE',
    playStyle:'playmaker',
    champions:['Hexwing','Fangwhisper','Wanderclaw','Driftblade'],
    contract:{ salary:0, yearsLeft:0, expiryYear:2026 },
